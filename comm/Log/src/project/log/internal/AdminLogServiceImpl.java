...
public class AdminLogServiceImpl implements AdminLogService {
	...
	public Page pagedQueryMoneyLog(int pageNo, int pageSize, String log_para, String name_para, String loginPartyId, String rolename_para, String startTime, String endTime) {
		...
		queryString.append(" money.UUID money_id,money.LOG log,money.WALLETTYPE wallettype,money.AMOUNT_BEFORE amount_before,money.AMOUNT amount,money.AMOUNT_AFTER amount_after,money.CREATE_TIME createTime,money.WALLETTYPE wallettype ");
		queryString.append(" FROM");
		queryString.append(" T_MONEY_LOG money LEFT JOIN PAT_PARTY party ON money.PARTY_ID = party.UUID  LEFT JOIN PAT_USER_RECOM user ON user.PARTY_ID = party.UUID  LEFT JOIN PAT_PARTY party_parent ON user.RECO_ID = party_parent.UUID   ");
