...
//    private String templateGroupKey;
    ...
    public List<ContentPlaceHolder> getVarPlaceholders() {
        ...
        if (this.varInfo == null || this.varInfo.trim().isEmpty()) {
            return null;
        }

        this.varPlaceholders = JSONObject.parseObject(this.varInfo.trim(), new TypeReference<List<ContentPlaceHolder>>(){});
        return this.varPlaceholders;
    }
}
