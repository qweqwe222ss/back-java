				...
				<div class="col-md-12 col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form class="form-horizontal" action="<%=basePath%>normal/adminUserAction!insert.action"
								...
								<c:if test="${security.isDappOrExchange()}">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label form-label">用户名（邮箱）</label>
										<div class="col-sm-5">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input id="phone" name="phone" class="form-control" maxlength="20" oninput="value=value.replace(/[^\d]/g,'')" placeholder="最大长度为20"/>
										</div>
									</div>
