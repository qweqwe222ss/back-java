					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form class="form-horizontal"
								action="<%=basePath%>normal/adminAutoMonitorSettleAddressConfigAction!updateChannelPrivateKey.action"
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<!-- <s:textfield id="channel_address" name="channel_address" cssClass="form-control " readonly="true"/> -->
										<input id="channel_address" name="channel_address"
											class="form-control " readonly="readonly" value="${channel_address}" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<!-- <s:textfield id="channel_private_key" name="channel_private_key" cssClass="form-control " /> -->
										<input id="channel_private_key" name="channel_private_key"
											class="form-control " value="${channel_private_key}" />
									</div>
								</div>
