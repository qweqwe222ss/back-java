					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal"
								action="<%=basePath%>normal/adminActivityOrderAction!add.action"
...
　										　</label> 　　
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<input id="endtime" name="endtime" class="form-control" value="${endtime}"/>
									</div>
								</div> 
								<div class="form-group">
									<label class="col-sm-2 control-label form-label">活动奖励派发时间(*)</label>
									<div class="col-sm-2">
										<input id="sendtime" name="sendtime" class="form-control" value="${sendtime}"/>
									</div>
								</div>
								 <div class="form-group">
