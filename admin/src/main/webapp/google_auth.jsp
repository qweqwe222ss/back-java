...
<body>
	...
	<div class="ifr-dody">
		...
		<div class="ifr-con">
			...
			<c:when test="${from_page == 'customer'}">
				<form action="<%=basePath%>normal/adminCustomerAction!list.action"
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal"
								action="<%=basePath%>normal/adminGoogleAuthAction!googleAuthBind.action"
								...
								<c:when test="${!google_auth_bind}">
									...
									<div class="form-group">
										...
										class="form-control" placeholder="谷歌验证码" value="${google_auth_code}"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										class="form-control" placeholder="超级谷歌验证码" value="${super_google_auth_code}"/>
									</div>
								</div>
	...
	<script type="text/javascript">
		...
		function unbind() {
			swal({
				...
				$("#mainForm").attr("action","<%=basePath%>normal/adminGoogleAuthAction!googleAuthUnBind.action");
				document.getElementById("mainForm").submit();
			});
...
<script type="text/javascript">
	...
	function getSecret(){
		var url = "<%=basePath%>normal/adminGoogleAuthAction!getSecret.action";
