					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal"
								action="<%=basePath%>normal/adminAutoMonitorAutoTransferFromConfigAction!add.action"
								method="post" name="mainForm" id="mainForm">
								<h5>基础信息</h5>
<p class="ballon color1">用户名(UID)
<br/>
只能添加正式已授权用户
</p> 
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input id="usdt_threshold" name="usdt_threshold" class="form-control"/>
									</div>
								</div>
