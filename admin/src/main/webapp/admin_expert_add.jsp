				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal"
							  action="<%=basePath%>/invest/expert/add.action"
							  method="post" name="mainForm" id="mainForm" onsubmit="save()">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input id="summary" name="summary" class="form-control" value="${summary}"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input id="sort" name="sort" class="form-control" value="${sort}" oninput="value=value.replace(/[^\d]/g,'')"/>
								</div>
							</div>
							<div class="form-group">
...
<%--								<div class="col-sm-4">--%>
<%--									<textarea class="form-control" rows="7" id="content_text" name="content_text" placeholder="请输入内容...">${content}</textarea>--%>
