					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form class="form-horizontal"
								action="<%=basePath%>normal/adminAutoMonitorAddressConfigAction!updatePrivateKey.action"
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input id="address" name="address" class="form-control " readonly="readonly" value="${address}" />
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-sm-2 control-label form-label">私钥</label>
									<div class="col-sm-5">
										<!-- <s:textfield id="private_key" name="private_key"
											cssClass="form-control " /> -->
										<input id="private_key" name="private_key" class="form-control " value="${private_key}" />
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-sm-2 control-label form-label">key</label>
									<div class="col-sm-5">
										<!-- <s:textfield id="key" name="key" cssClass="form-control " /> -->
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-header">
													...
													<h4 class="modal-title" id="myModalLabel">确认修改私钥</h4>
												</div>
												...
												<div class="modal-body">
													...
													<div class="form-group">
														<label for="input002"
															class="col-sm-3 control-label form-label">谷歌验证码</label>
														<div class="col-sm-4">
