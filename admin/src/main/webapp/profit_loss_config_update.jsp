...
<body>
	...
	<div class="ifr-dody">
		...
		<div class="ifr-con">
			...
			<!-- START queryForm -->
			<form
				action="<%=basePath%>normal/adminProfitAndLossConfigAction!list.action"
				...
				<div class="col-md-12 col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal" action="<%=basePath%>normal/adminProfitAndLossConfigAction!update.action"
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input id="usercode" name="usercode"
											class="form-control " readonly="readonly" value="${usercode}" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<!-- <s:select id="type" cssClass="form-control " name="type"
											list="type_map" listKey="key" listValue="value" value="type" /> -->
