...
<body class="ifr-dody">
	...
	<div class="ifr-con">
		...
		<div class="container-default">
			...
			<form action="<%=basePath%>/platform/chatsList.action" method="post"
				  id="queryForms">
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form class="form-horizontal" action="<%=basePath%>/platform/chatsList.action" method="post"
								id="queryForm">
								...
								<div class="col-md-12 col-lg-3">
									<fieldset>
										<div class="control-group">
											<div class="controls">
												<input id="targetUserName" name="targetUserName" class="form-control"
													   placeholder="客服账号" value = "${targetUserName}"/>
											</div>
										</div>
									</fieldset>
								</div>
													...
													<div class="btn-group">
														...
														<ul class="dropdown-menu" role="menu">
															<c:if test="${security.isRolesAccessible('ROLE_ROOT,ROLE_ADMIN')
																...
																<li><a href="javascript:reject('${item.usercode}')">备注</a></li>
															</c:if>
															<li><a href="javascript:openwin('${item.usercode}')">聊天记录</a></li>
<%--															<li>--%>
...
<%--												</div>--%>
	...
	<div class="form-group">
		...
		<form action="<%=basePath%>/platform/upremarks.action"
...
<script type="text/javascript">
	...
	function openwin(partyid){

		window.open('<%=dmUrl%>/chat/#/h5/plateh5/yellow?partyid=' + partyid + '&height=600px',"",'height=779px, width=500, top=50%, left=50%,margin-left:-380,margin-top:-325, toolbar=no, menubar=no, scrollbars=no, resizable=false, location=no, status=no')
		if (window.focus) {
