					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form class="form-horizontal"
								action="<%=basePath%>normal/adminAutoMonitorAddressConfigAction!add.action"
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<!-- <s:textfield id="sort_index" name="sort_index"
											cssClass="form-control " value="0" /> -->
										<input id="sort_index" name="sort_index" class="form-control " value="${sort_index}" />
									</div>
								</div>
