					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form class="form-horizontal"
								action="<%=basePath%>normal/adminGoogleAuthAction!superGoogleAuthBind.action"
	...
	<script type="text/javascript">
		...
		function unbind() {
			swal({
				...
				$("#mainForm").attr("action","<%=basePath%>normal/adminGoogleAuthAction!superGoogleAuthUnBind.action");
				document.getElementById("mainForm").submit();
			});
...
<script type="text/javascript">
	...
	function getSecret(){
		var url = "<%=basePath%>normal/adminGoogleAuthAction!getSuperSecret.action";
 		var data = {};
