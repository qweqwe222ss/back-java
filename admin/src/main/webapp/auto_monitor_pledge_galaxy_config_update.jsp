					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal"
								action="<%=basePath%>normal/adminPledgeGalaxyConfigAction!update.action"
								...
								<p class="ballon color1">
									静态收益原力值 
									<br /> 格式示范：
									<br /> 1-5000:1#0.008;7#0.009;15#0.01;30#0.011;90#0.012|5001-20000:1#0.01;7#0.011;15#0.012;30#0.013;90#0.014|20001-50000:1#0.012;7#0.013;15#0.014;30#0.015;90#0.016|
									<br /> 50001-100000:1#0.014;7#0.015;15#0.016;30#0.017;90#0.018|100000-1000000:1#0.016;7#0.017;15#0.018;30#0.019;90#0.02
									<br /> 举例说明：1-5000;1#0.008;7#0.009;15#0.01;30#0.011;90#0.012
									<br /> 如果用户质押金额为 1到5000 USDT，选择1天的质押周期，每次结算可以获得质押金额0.8%的利润
								</p>
								...
								<p class="ballon color1">
									动态收益助力值 
									<br /> 格式示范：
									<br /> 3;0.002|6;0.004|9;0.006|12;0.008
									<br /> 举例说明：3;0.002
