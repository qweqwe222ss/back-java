...
<!-- 				<s:hidden name="type_para" id="type_para"></s:hidden> -->
				...
				<input type="hidden" name="type_para" id="type_para" value="${type_para}">
			</form>
			<!-- END queryForm -->
			<!-- //////////////////////////////////////////////////////////////////////////// -->
...
<!-- 								<s:hidden name="type_para" id="type_para"></s:hidden> -->
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input id="menu_ip" name="menu_ip" class="form-control " value="${menu_ip}"/>
									</div>
								</div>
									...
									<div class="col-sm-2">
										<div class="controls">
											<%-- <s:select id="menu_type" cssClass="form-control "
												name="menu_type"
												list="#{'black':'黑名单','lock':'锁定名单','white':'白名单'}"
											...
											<select id="menu_type" name="menu_type" class="form-control " >
											   ...
											   <option value="lock" <c:if test="${menu_type == 'lock'}">selected="true"</c:if> >锁定名单</option>
