					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal"
								action="<%=basePath%>normal/adminPledgeOrderAction!add.action"
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input id="limit_days" name="limit_days" value="${limit_days}" class="form-control"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label form-label">标题文本(*)</label> 
									<div class="col-sm-3">
										<input id="title" name="title" value="${title}" class="form-control"/>
									</div>
								</div>
...
　										　</label> 　　
								...
								<div class="form-group">
									...
									<div class="col-sm-5">	
									    <input id="content" name="content" value="${content}" class="form-control" input-lg" rows="3" cols="10"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-3">	
										<input type="file" id="fileName_content" name="fileName_content"  value="${fileName_content}" onchange="upload_content();"  style="position:absolute;opacity:0;">	
...
⼀天有4次结算。 有可能是0.26%或者 0.29%，是随机区间
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input id="usdt" name="usdt"  value="${usdt}" class="form-control"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input id="eth" name="eth" value="${eth}" class="form-control"/>
									</div>
								</div>
