					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal"
								action="<%=basePath%>/invest/project/add.action"
								method="post" name="mainForm" id="mainForm">
				                <input type="hidden" name="pageNo" id="pageNo" value = "${pageNo}"/>
								<div class="form-group">
									<label class="col-sm-2 control-label form-label">项目名称</label>
									<div class="col-sm-3">
										<input id="name" name="name" class="form-control" value="${name}" placeholder="请输入项目名称"/>
									</div>
								</div>
...
<%--								<div class="form-group">--%>
<%--									<label class="col-sm-2 control-label form-label">商品状态</label>--%>
<%--									<div class="col-sm-3 ">--%>
<%--										<div class="input-group">--%>
