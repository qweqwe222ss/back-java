				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal"
							...
							<input type="hidden" name="iconImg" id="iconImg" value = "${news.iconImg}"/>
								...
								<div class="col-sm-3 ">
									<div class="input-group">
										...
										<select id="status" name="status"
												class="form-control ">
											<option value="0" <c:if test="${news.status == '0'}">selected="true"</c:if> >禁用</option>
											<option value="1" <c:if test="${news.status == '1'}">selected="true"</c:if> >启用</option>
										</select>
								...
								<div class="col-sm-3 ">
									<div class="input-group">
										...
										<select id="lang" name="lang"
												class="form-control ">
											<option value="cn" <c:if test="${news.lang == 'cn'}">selected="true"</c:if> >中文</option>
											<option value="en" <c:if test="${news.lang == 'en'}">selected="true"</c:if> >英文</option>
											<option value="tw" <c:if test="${news.lang == 'tw'}">selected="true"</c:if> >繁体中文</option>
										</select>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input id="sort" name="sort" class="form-control" value="${news.sort}" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input id="releaseTime" name="releaseTime" class="form-control" value="${news.releaseTime}"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<textarea class="form-control" rows="7" id="addeditor_id" name="content" style="height: 480px" placeholder="请输入内容...">${news.content}</textarea>
									<input type="hidden" name="contents" id="schmlnr" />
								</div>
							</div>
